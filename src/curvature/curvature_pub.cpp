...
public:
    TerrainPlaneSegmentation() : Node("terrain_plane_segmentation") {
        ...
        cloud_subscriber_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
            "/camera/depth/color/points", 10, std::bind(&TerrainPlaneSegmentation::pointCloudCallback, this, std::placeholders::_1));

        // cloud_subscriber_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
        //     "/processed_points", 10, std::bind(&TerrainPlaneSegmentation::pointCloudCallback, this, std::placeholders::_1));

        // Publishers for segmented planes and curvature
        plane_publisher_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/segmented_planes", 10);
        curvature_publisher_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("/curvature_visualization", 10);
...
private:
    void pointCloudCallback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
        ...
        segmentPlanesAndCurvature(cloud, msg->header);
    }
